...
\resumeItem{Design architecture and implement end-to-end DICE Protection Environment scheme for new generation of Server products based on TCG iROT Profile.}
...
\resumeSubHeadingListStart
    ...
    {AMD}{2019 (1 time), 2020 (1 time), 2021 (3 times), 2023 (2 times)}
    \resumeSubheading
