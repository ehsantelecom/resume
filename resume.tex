...
\resumeItem{Scaled Caliptra DPE (TCG reference code) implementation from RUST code into C with a wrapper. Validated all DPE commands based on AMD use-cases and flagged many improvements for the Caliptra WG}
...
\resumeItem{Threat modeling for some of critical features that require certificate as identifications (link encryption, multi-client DPE services, etc).}
...
\resumeItem{Represented the PSP team during the pre-silicon phase of successful programs such as Vega20, Mi100, Mi200, Mi300, Turin, Venice and contributed to their bring-up.}
...
\resumeItem{Mentored numerous newly hired engineers ranged from Co-ops to Principal Member of Technical Staff. Acted as one of the first points of contact for the security FW team to provide AMD internal consultations.}
\resumeItem{Contributed actively in TCG WG spec at \url{https://github.com/TrustedComputingGroup/Server-Internal/}}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    {AMD}{2019 (1 time), 2020 (1 time), 2021 (3 times), 2023 (2 times), 2024 (2 times)}
    \resumeSubheading
